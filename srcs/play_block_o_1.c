...
/*   Updated: 2017/04/12 21:31:20 by bskiba           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (cheeck_left_x_2(data) == 0 || cheeck_top_x(data) == 0)
	{
		if (ft_play_up_left(data, piece) == 1)
			return (1);
	}
	else if (cheeck_down_x(data) == 0 && cheeck_down_point(data) == 1)
	{
		if (ft_play_down_right(data, piece) == 1)
			return (1);
	}
	else if (cheeck_left_x(data) == 0)
	{
		if (ft_play_up_left(data, piece) == 1)
			return (1);
	}
	else if (cheeck_right_point(data) == 1 && cheeck_poso(data) == 1)
	{
